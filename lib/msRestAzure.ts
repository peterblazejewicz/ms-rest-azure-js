...
import { AzureServiceClient, AzureServiceClientOptions } from "./azureServiceClient";
...
export { AzureServiceClient, AzureServiceClientOptions, Constants, CloudError, CloudErrorMapper, BaseResource,
